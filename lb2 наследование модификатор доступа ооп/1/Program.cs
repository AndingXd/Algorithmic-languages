...
namespace CsharpProject{
    ...
    public class Pupil
    {
       public void Info()
        ...
        {
            Console.WriteLine("Я умею читать книги!");
        }
        ...
        {
            Console.WriteLine("Я иногда отдыхаю в свободное время!");
        }
    }
    ...
    public class BadPupil : Pupil
    {
        ...
        protected override void Relax()
        {
            Console.WriteLine("Я предпочитаю отдыхать лёжа!");
        }

        protected override void Write()
        {
            Console.WriteLine("Я люблю отлынивать от дз!");
        }
    }
}