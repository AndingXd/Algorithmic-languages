...
class Program
{
    ...
    private const string apiKey = "bURTMGI3QWhkU1ppWjA3ZWNaeFM0TTRpaU9UUklXWnZQYlQ1NnJBbUV2Zz0";
    ...
    static async Task Main(string[] args)
    {
        ...
        Console.WriteLine("Средние цены акций занесены в average_prices.txt.");
